...
export const guidedMathGoals: GuidedMathGoalDefinition[] = [
  ...
  },
  {
    ...
    label: 'Question asks for XL from frequency and inductance',
    description: 'Use this when the problem gives frequency and an inductor value and asks for XL.',
    questionCue: 'The problem gives f and L and wants the inductive reactance XL.',
  ...
  },
  {
    ...
    chapter: '14',
    section: 'Basic elements and phasors',
    label: 'Question asks for inductor L from XL and frequency',
    description: 'Use this when the problem shows an inductor reactance in ohms, gives frequency, and asks for L.',
    questionCue: 'The question gives XL and f and wants the inductor value L.',
    target: 'inductance',
    inputs: ['inductiveReactance', 'frequency'],
    note: 'Example: if the diagram shows 6 ohms on the inductor and the problem says 1 kHz, use this goal. You do not need to reduce the whole circuit first.',
  },
  {
    id: 'capacitance-from-reactance-and-frequency',
    chapter: '15',
    section: 'Basic elements and phasors',
    label: 'Question asks for capacitor C from XC and frequency',
    description: 'Use this when the problem shows capacitor reactance in ohms, gives frequency, and asks for C.',
    questionCue: 'The question gives XC and f and wants the capacitor value C.',
    target: 'capacitance',
  ...
  },
  {
    ...
    chapter: '15',
    section: 'Waveform and phasor conversion',
    label: 'Question gives i(t) and asks for the current phasor',
    description: 'Use this when the problem is written as a sine-wave current and asks for the phasor.',
    questionCue: 'Look for i(t), a peak current, and an angle in the sine expression.',
  ...
  },
  {
    ...
    chapter: '15',
    section: 'Waveform and phasor conversion',
    label: 'Question gives v(t) and asks for the voltage phasor',
    description: 'Use this when the problem is written as a sine-wave voltage and asks for the phasor.',
    questionCue: 'Look for v(t), a peak voltage, and an angle in the sine expression.',
    target: 'phasorSourceVoltage',
  ...
  },
  {
    ...
    chapter: '15',
    section: 'Waveform and phasor conversion',
    label: 'Question gives a current phasor and asks for i(t)',
    description: 'Use this when the problem gives the phasor and omega and wants the sinusoidal current expression.',
    questionCue: 'Look for an RMS current phasor plus omega, and the question asking for i(t).',
  ...
  },
  {
    ...
    chapter: '15',
    section: 'Waveform and phasor conversion',
    label: 'Question gives a voltage phasor and asks for v(t)',
    description: 'Use this when the problem gives the phasor and omega and wants the sinusoidal voltage expression.',
    questionCue: 'Look for an RMS voltage phasor plus omega, and the question asking for v(t).',
  ...
  },
  {
    ...
    chapter: '15',
    section: 'Series AC power',
    label: 'Question gives P, V, and pf and asks for Z',
    description: 'Use this when the problem gives power, voltage, and power factor and asks for total impedance.',
    questionCue: 'Look for P, V, and pf with the question asking for Z or ZT.',
    formulaSummary: [
      'I = P / (V pf)',
      '|Z| = V / I = V^2 pf / P',
  ...
  },
  {
    ...
    label: 'Question gives E and I phasors and asks for ZT',
    description: 'Use this when the problem gives source voltage and source current as phasors and asks for total impedance.',
    questionCue: 'Look for E and I written with magnitude and angle, then a question asking for Z or ZT.',
  ...
  },
  {
    ...
    chapter: '15',
    section: 'Phasor relationships',
    label: 'Question asks for one branch voltage from E, Zbranch, and Ztotal',
    description: 'Use this when the problem gives the source phasor plus the branch and total impedances and asks for a branch voltage.',
    questionCue: 'Look for E, one branch impedance, total impedance, and a branch-voltage ask.',
  ...
  },
  {
    ...
    label: 'Question asks for ZT of a resistor in parallel with a coil',
    description: 'Use this when the problem shows a resistor branch in parallel with a coil that has both resistance and inductance.',
    questionCue: 'Look for a resistor branch in parallel with a coil branch and a question asking for total impedance.',
    formulaSummary: [
      'XL = 2pi f L',
      'Zcoil = Rcoil + jXL',
  ...
  },
  {
    ...
    label: 'Question asks for G from R',
    description: 'Use this when the problem gives resistance and asks for conductance.',
    questionCue: 'Look for a resistance value and the letter G in the question.',
    target: 'conductance',
    inputs: ['resistance'],
  },
  {
    ...
    chapter: '16',
    section: 'Parallel AC building blocks',
    label: 'Question asks for BL from XL',
    description: 'Use this when the problem gives inductive reactance and asks for inductive susceptance.',
    questionCue: 'Look for XL in ohms and the question asking for BL.',
  ...
  },
  {
    ...
    chapter: '16',
    section: 'Parallel AC building blocks',
    label: 'Question asks for BC from XC',
    description: 'Use this when the problem gives capacitive reactance and asks for capacitive susceptance.',
    questionCue: 'Look for XC in ohms and the question asking for BC.',
  ...
  },
  {
    ...
    chapter: '16',
    section: 'Parallel AC building blocks',
    label: 'Question asks for BC from frequency and C',
    description: 'Use this when the problem gives frequency and capacitance and asks for capacitive susceptance.',
    questionCue: 'Look for f and C with the question asking for BC.',
  ...
  },
  {
    ...
    chapter: '16',
    section: 'Parallel AC building blocks',
    label: 'Question gives G, BL, and BC and asks for YT',
    description: 'Use this when the problem gives conductance and susceptance pieces and asks for total admittance.',
    questionCue: 'Look for G, BL, and BC with the question asking for Y or YT.',
  ...
  },
  {
    ...
    label: 'Question gives voltage and |Y| and asks for total current',
    description: 'Use this when the problem gives source voltage and admittance magnitude and asks for source current.',
    questionCue: 'Look for V and |Y| with the question asking for I or Is.',
    target: 'current',
  ...
  },
  {
    ...
    chapter: '16',
    section: 'Parallel AC networks',
    label: 'Question gives G and |Y| and asks for power factor',
    description: 'Use this when the problem gives conductance and admittance magnitude and asks for power factor.',
    questionCue: 'Look for G and |Y| with the question asking for pf.',
    target: 'powerFactor',
